...
class XMLToArray {
	...
	// PROTECTED Start a new Element. This means we push the new element onto the stack and reset it's properties.
	...
	// PROTECTED End an element. This is done by popping the last element from the stack and adding it to the previous element on the stack.
	...
	// PROTECTED Collect the data onto the end of the current chars.
