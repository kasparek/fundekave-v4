jQuery.base64=function(a){function b(a,b){var c=d.indexOf(a.charAt(b));if(-1===c)throw"Cannot decode base64";return c}function c(a,b){var c=a.charCodeAt(b);if(255<c)throw"INVALID_CHARACTER_ERR: DOM Exception 5";return c}var d="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";return{decode:function(a){var c=0,d,h,k=a.length,m=[];a=String(a);if(0===k)return a;if(0!==k%4)throw"Cannot decode base64";"="===a.charAt(k-1)&&(c=1,"="===a.charAt(k-2)&&(c=2),k-=4);for(d=0;d<k;d+=4)h=b(a,d)<<
18|b(a,d+1)<<12|b(a,d+2)<<6|b(a,d+3),m.push(String.fromCharCode(h>>16,h>>8&255,h&255));switch(c){case 1:h=b(a,d)<<18|b(a,d+1)<<12|b(a,d+2)<<6;m.push(String.fromCharCode(h>>16,h>>8&255));break;case 2:h=b(a,d)<<18|b(a,d+1)<<12,m.push(String.fromCharCode(h>>16))}return m.join("")},encode:function(a){if(1!==arguments.length)throw"SyntaxError: exactly one argument required";a=String(a);var b,g,h=[],k=a.length-a.length%3;if(0===a.length)return a;for(b=0;b<k;b+=3)g=c(a,b)<<16|c(a,b+1)<<8|c(a,b+2),h.push(d.charAt(g>>
...
if(0==a.indexOf(f)){var k=parseInt(a.substr(5)),m=1;$("span.month",c[0]).each(function(){m==k&&($(this).addClass("active"),$(this).attr("title",b));m++})}}else f=calendarDate?calendarDate:c.datepicker("getDate"),f=f.getFullYear()+"-"+("0"+(f.getMonth()+1)).slice(-2)+"-",0==a.indexOf(f)&&$("td.day",c[0]).each(function(){var c=parseInt($(this).html()),d=parseInt(a.substr(8));c!=d||$(this).hasClass("new")||$(this).hasClass("old")||($(this).addClass("active"),$(this).attr("title",b))})})}
...
1)}c||(c={});var e=jQuery.extend(!0,{url:b,cache:!1,methodLight:"GET",methodLoaded:"POST",data:"",minTimeout:1E3,maxTimeout:64E3,multiplier:2,maxCalls:0,autoStop:0,autoStopCallback:null,cookie:!1,runatonce:!1,verbose:0},c),g=function(a,b){if(e.verbose>=(b||1))try{console.log(a)}catch(c){}},h=null,k=null,m=null,l=e.minTimeout,p=e.maxCalls,u=e.autoStop,s=0,r=0,v=p,n=function(b){a(function(){null!==h&&clearTimeout(h);l=b;g("resetting timer to "+l+".",2);e.cookie&&a.cookie&&a.cookie(e.cookie.name,l,e.cookie);
...
2),n(l))}).fail(function(){g("Could not load the cookies handler script",1);n(l)}));var q=jQuery.extend(!0,{},e);e.type&&!q.dataType&&(q.dataType=e.type);e.sendData&&(q.data=e.sendData);q.ifModified=!0;var t={boostTimer:function(a){0<a&&1!=a?(g("Boosting timer by a factor of "+a),l*=a):g("Cannot boost timer by a factor of "+a);n(l)},restart:function(a){g("Calling restart");p=v;r=s=0;n(a||l)},send:function(){g("Explicit call to send");f(!0)},stop:function(){g("Calling stop");p=-1;e.cookie&&a.cookie&&
a.cookie(e.cookie.name,null,e.cookie)}};q.success=function(a){g("Successful run! (In 'success')",2);k=a};q.complete=function(b,c){g("Status of call: "+c+" (In 'complete')",2);if("success"==c||"notmodified"==c){var f=a.trim(b.responseText);if(m==f){if(0<u&&(r++,r==u)){t.stop();e.autoStopCallback&&e.autoStopCallback(r);return}1<e.multiplier&&(f=l,l*=e.multiplier,l>e.maxTimeout&&(l=e.maxTimeout),g("adjusting timer from "+f+" to "+l+".",2));n(l)}else r=0,n(e.minTimeout),m=f,e.cookie&&a.cookie(e.cookie.name,
m,e.cookie),null===k&&(k=f),"json"===q.dataType&&"string"===typeof k&&"success"==c&&(k=JSON.parse(k)),e.success&&e.success(k,c,b,t),d&&d(k,c,b,t)}e.complete&&e.complete(b,c);k=null};q.error=function(b,c){g("Error message: "+c+" (In 'error')",2);"notmodified"!=c&&(m=null,e.cookie&&a.cookie(e.cookie.name,null,e.cookie),n(e.minTimeout));e.error&&e.error(b,c)};e.runatonce?(g("Executing a call immediately",1),f(!0)):a.cookie&&a.cookie(e.cookie.name)||(g("Enqueing a the call for after "+l,1),n(l));return t};
