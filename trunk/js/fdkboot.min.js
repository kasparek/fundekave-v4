...
c+'" class="noscreen" />'),a.il[c]=$("#imgNextLoader"+c).load(a.preloaded),a.il[c].attr("src",e).data("i",c))};a.preloaded=function(b){b=$(b.target);a.next[b.data("i")]=b.attr("src")}},Slideshow=new function(){var a=this;a.on=!1;a.t=0;a.s=5;a.f=function(){a.on&&$("#prevButt").click()};a.toggle=function(){a.on=!a.on;a.next()};a.next=function(){clearTimeout(a.t);a.on&&(a.t=setTimeout(a.f,1E3*a.s))}},Fullscreen=new function(){var a=this;a.el=null;a.tool=null;a.state=null;a.isFullscreen=!1;a.d=$(document.documentElement);
