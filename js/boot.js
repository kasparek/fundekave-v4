_fdk.load = {'boot':['//code.jquery.com/jquery-2.1.4.min.js',
...
'richta':['//cdn.tiny.cloud/1/rlnhwtwriypwnvwpob4rlhb8uxf1niuzgatjf7mx0d7yjunc/tinymce/5/tinymce.min.js'],
'filepond':[_fdk.cfg.jsUrl+'filepond.min.js']};
