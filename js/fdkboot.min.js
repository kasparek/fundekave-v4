...
function calendarInit() {
  ...
  $("#calendar-inline").on("show", function() {
    ...
    calendarInlineInvalidate();
  }).datepicker({date:date, language:"cs", startView:viewMode ? viewMode : 0, weekStart:1, multidate:true}).on("changeYear", function(e) {
      ...
      for (i = 0;i < galeryDateLoaded[selectedDate.year].length;i++) {
        ...
        if (viewMode === 0) {
          if (selectedDate.month == $(page).data("month")) {
            if (!galGrouped[$(page).data("date")]) {
              galGrouped[$(page).data("date")] = 0;
            }
            galGrouped[$(page).data("date")]++;
          }
        } else {
          if (viewMode === 1) {
            if (!galGrouped[$(page).data("month")]) {
              galGrouped[$(page).data("month")] = 0;
            }
...
(function(o) {
  ...
  o.init = function() {
    ...
    var keyupHandler = function(e) {
      ...
      if (i >= o.numCell) {
        i = Fullscreen.isFullscreen ? 0 : o.numCell - 1;
      } else {
        if (i < 0) {
          i = Fullscreen.isFullscreen ? o.numCell - 1 : 0;
        }
      }
      if (i != o.currentIndex) {
        o.currentIndex = i;
  ...
  o.handleNextPrev = function(e, isAnimate) {
    ...
    if (Fullscreen.isFullscreen) {
      ...
      if (e || isAnimate) {
        ...
        $("html, body").scrollTop(i.offset().top - ($(window).height() - i.height()) / 2);
      }
    }
    if (e) {
...
(function(o) {
  ...
  o.init = function() {
    ...
    $("#aSlideshow").click(function() {
      if (Slideshow.on) {
        $("#aSlideshow span").addClass("glyphicon-play").removeClass("glyphicon-stop");
      } else {
        $("#aSlideshow span").addClass("glyphicon-stop").removeClass("glyphicon-play");
      }
      Slideshow.toggle();
      return false;
    });
...
!function() {
  var a = "undefined" != typeof module && module.exports, b = "undefined" != typeof Element && "ALLOW_KEYBOARD_INPUT" in Element, c = function() {
    ...
    "mozFullScreenElement", "mozFullScreenEnabled", "mozfullscreenchange", "mozfullscreenerror"], ["msRequestFullscreen", "msExitFullscreen", "msFullscreenElement", "msFullscreenEnabled", "MSFullscreenChange", "MSFullscreenError"]], d = 0, e = c.length, f = {};e > d;d++) {
