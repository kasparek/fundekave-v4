...
a.add(d[0],d[1]),"result"==d[0]&&(g=!0),"resultProperty"==d[0]&&(h=!0);e&&(g||a.add("result",e),h||a.add("resultProperty","$html"));a.send(c,f);return!1};a.form=function(b,c){var d=b?b.currentTarget:null,f=d?$(d):null;if(!(!b&&!c||b&&!$(d.form).hasClass("fajaxform")||f&&f.hasClass("noFajax"))){b&&b.preventDefault();if(1==a.formStop)return a.formStop=!1;if(f&&f.hasClass("confirm")&&!confirm(f.attr("title")))return!1;tinymce&&tinymce.triggerSave();a.formSent=c?c:d.form;for(var f=$(a.formSent).serializeArray(),
...
var b=$("img.gallery-cell-image:first")[0];if(b.complete)isMobile?a.unveilInit():setTimeout(a.doQueue,500);else $(b).on("load",function(){isMobile?a.unveilInit():setTimeout(a.doQueue,500)});$(".gallery img").load(function(){var b=$(window),d=b.width(),b=b.height();imgResizeToFit($(this),Fullscreen.isFullscreen?d:$("#fullscreenBox").width(),b-0,Fullscreen.isFullscreen);ImgNext.hud();a.isQueue&&0<a.queue.length&&a.nextQueue()}).error(function(){var a=(new Date).getTime(),a=$(this).attr("src")+"?"+a;
$(this).attr("src",a);console.log("Error Loading Image "+a)});$(".js-flickity").on("cellSelect",function(){var b=$(".gallery").data("flickity");if(b){var d=b.selectedElement,b=!0;a.flktySelected||(b=!1);a.flktySelected==d&&(b=!1);a.flktySelected=d;b&&(b=$("img",d),$(b).data("lazy")&&($(b).attr("src",$(b).data("lazy")),$(b).data("lazy",null)),a.flktyTimeout&&clearTimeout(a.flktyTimeout),a.flktyTimeout=setTimeout(function(){var a=$(d).data("itemid");History.pushState({action:"item-show",eid:a,i:a},
"Loading ...","?i="+a)},1E3))}})};a.force=function(){a.cw=a.ch=0;a.on()};a.on=function(){var b=$(window),c=b.width(),d=b.height();if(c!=a.cw||d!=a.ch)a.cw=c,a.ch=d,ImgNext.hud();$(".gallery img").each(function(a){imgResizeToFit($(this),Fullscreen.isFullscreen?c:$("#fullscreenBox").width(),d-0,Fullscreen.isFullscreen,Fullscreen.isFullscreen)})}},ImgNext=new function(){var a=this;a.r=!1;a.i=null;a.il=[];a.p=null;a.next=[];a.nav=[];a.top=0;a.xhr=null;a.thumbsInit=function(){$(".thumbnail-xs a").each(function(){$(this).on("click",
function(a){var c=gup("i",a.currentTarget.href);History.pushState({action:"item-show",eid:$(a.target).attr("id"),i:c},"Loading ...","?i="+c);c=$("#fullscreenBox");$("html, body").animate({scrollTop:c.offset().top-($(window).height()-c.height())/2},600);return!1})})};a.init=function(){a.r||(a.r=!0,a.i=$("#detailFoto"),a.i.bind("load",a.loaded),a.p=$(".showProgress"))};a.start=function(b){a.init();a.i.show();var c=a.p.height();a.p.css("height",(0<c?c:$(window).height())+"px");a.i.removeAttr("src");
a.next[b]?(History.log("Galery showing:",b),a.i.attr("src",a.next[b])):a.i.css("height","0px");if(a.nav[b]){var c=$("#nextButt"),d=$("#prevButt"),f=c.attr("href"),e=d.attr("href"),f=f.substr(0,f.indexOf("i=")+2)+a.nav[b][0],e=e.substr(0,e.indexOf("i=")+2)+a.nav[b][1];c.attr("href",f);d.attr("href",e)}return!1};a.loaded=function(){};a.hud=function(){var a=$("#fullscreenBox");a.css("height","").css("width","");var c=a.width(),a=a.height(),a=$(window).height(),d=0;$(".gallery-cell img").each(function(){var a=
$(this).height();a>d&&(d=a)});isMobile||$(".gallery").width(c).height(d);History.log("ImgNext.hud",c+"x"+a)};a.xhrHand=function(b,c,d,f,e){a.init();a.nav[b]=[c,d];f&&f!=a.i.attr("src")&&a.i.attr("src",f).data("i",b);e&&($("body").append('<img id="imgNextLoader'+c+'" class="noscreen" />'),a.il[c]=$("#imgNextLoader"+c).load(a.preloaded),a.il[c].attr("src",e).data("i",c))};a.preloaded=function(b){b=$(b.target);a.next[b.data("i")]=b.attr("src")}},Slideshow=new function(){var a=this;a.on=!1;a.t=0;a.s=
5;a.f=function(){a.on&&(isMobile?$("#galleryNext").click():$(".gallery").flickity("next"),a.next())};a.toggle=function(){a.on=!a.on;a.next()};a.next=function(){clearTimeout(a.t);a.on&&(a.t=setTimeout(a.f,1E3*a.s))}},Fullscreen=new function(){var a=this;a.el=null;a.tool=null;a.state=null;a.isFullscreen=!1;a.d=$(document.documentElement);a.w=$(window);a.key=function(b){27==b.keyCode&&a.toggle();32==b.keyCode&&$("#nextButt").click()};a.init=function(){a.el=$("#fullscreenBox");if(0!==a.el.length){listen("aFullscreen",
"click",a.toggle);$("#fullscreenLeave").click(a.toggle);$("#prevButt").click(function(){return!1});$("#nextButt").click(function(){return!1});a.tool=$("#photoToolbar");var b=$("#aSlideshow img");b.click(function(){b.attr("src",b.attr("src").replace(Slideshow.on?"stop":"play",Slideshow.on?"play":"stop"));Slideshow.toggle();return!1});Resize.init()}};a.toggle=function(){if(a.isFullscreen)a.onExit();else a.onEnter();return!1};a.onEnter=function(){a.isFullscreen=!0;a.state={y:a.w.scrollTop()};a.d.bind("keyup",
a.key);a.el.addClass("fullscreen");a.w.scrollTop(0).scrollLeft(0);$("body").css("overflow","hidden");Resize.force()};a.onExit=function(){a.isFullscreen=!1;a.d.unbind("keyup",a.key);a.el.removeClass("fullscreen");$("body").css("overflow","auto");0<a.state.y&&a.w.scrollLeft(a.state.y);a.state=null;Resize.force()}};
