...
(function(a){a.fn.funveil=function(b,c){function d(){k=h.filter(function(){var b=a(this);if(!b.is(":hidden")){var c=f.scrollTop(),d=c+f.height(),g=b.offset().top;return g+b.height()>=c-e&&g<=d+e}}).trigger("unveil");h=h.not(k)}var f=a(window),e=b||0,g=1<window.devicePixelRatio?"data-lazy-retina":"data-lazy",h=this,k;a(this).height(f.height()).width("100%").addClass("funveil");this.one("unveil",function(){var a=this.getAttribute(g);if(a=a||this.getAttribute("data-lazy"))this.setAttribute("src",a),
"function"===typeof c&&c.call(this)});f.on("scroll.unveil resize.unveil lookup.unveil",d);d();return this}})(window.jQuery||window.Zepto);
